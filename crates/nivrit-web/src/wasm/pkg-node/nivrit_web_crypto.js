 ...
 * @returns {any}
 */
function assess_password(password, email) {
    try {
...
exports.assess_password = assess_password;
 ...
 * @returns {any}
 */
function decapsulate_project_key(encapsulated, private_key_b64) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.decapsulate_project_key = decapsulate_project_key;
 ...
 * @returns {any}
 */
function decrypt_private_key(encrypted_private_key_b64, nonce_b64, password) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.decrypt_private_key = decrypt_private_key;
 ...
 * @returns {any}
 */
function decrypt_value(ciphertext_b64, nonce_b64, key_b64) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.decrypt_value = decrypt_value;
 ...
 * @returns {string}
 */
function derive_auth_hash(password, email) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.derive_auth_hash = derive_auth_hash;
 ...
 * @returns {string}
 */
function derive_recovery_auth_hash(recovery_code, email) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.derive_recovery_auth_hash = derive_recovery_auth_hash;
 ...
 * @returns {any}
 */
function encapsulate_project_key(project_key_b64, recipient_public_key_b64) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.encapsulate_project_key = encapsulate_project_key;
 ...
 * @returns {any}
 */
function encrypt_value(plaintext, key_b64) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.encrypt_value = encrypt_value;
 ...
 * @returns {any}
 */
function generate_registration_material(password, email) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(password, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
...
exports.generate_registration_material = generate_registration_material;
 ...
 * @returns {any}
 */
function generate_user_keypair(password) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(password, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
...
exports.generate_user_keypair = generate_user_keypair;

/**
 * Return the suite identifier used for hybrid project-key encapsulation.
 * @returns {string}
 */
function hybrid_suite_id() {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.hybrid_suite_id = hybrid_suite_id;
 ...
 * @returns {any}
 */
function reset_password_material(encrypted_private_key_recovery_b64, private_key_recovery_nonce_b64, recovery_code, email, new_password) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
exports.reset_password_material = reset_password_material;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./nivrit_web_crypto_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/nivrit_web_crypto_bg.wasm`;
